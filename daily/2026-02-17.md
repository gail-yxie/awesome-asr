...
|------|--------|------|------|
| openai/whisper-large-v3-turbo | openai | model | [HF](https://huggingface.co/openai/whisper-large-v3-turbo) |
| distil-whisper/distil-large-v3 | distil-whisper | model | [HF](https://huggingface.co/distil-whisper/distil-large-v3) |
| Qwen/Qwen3-ASR-1.7B | Qwen | model | [HF](https://huggingface.co/Qwen/Qwen3-ASR-1.7B) |
| espnet/yodas-granary | espnet | dataset | [HF](https://huggingface.co/datasets/espnet/yodas-granary) |
